...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🍁 ʜᴏᴡ ᴛᴏ ᴜꜱᴇ 🍁', url="https://t.me/TamilSk_Demo")
                  ]]
    ...
    if data.split("-", 1)[0] == "BATCH":
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/SKT_Movies') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, ʏᴏᴜ ᴀʀᴇ sᴜᴄᴄᴇssғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ ғᴏʀ 24ʜʀs ❤️‍🩹\n\nʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀɴʏ ᴍᴏᴠɪᴇ ғɪʟᴇs ᴡɪᴛʜᴏᴜᴛ ᴠᴇʀɪғɪʏ ᴜɴᴛɪʟʟ ɴᴇxᴛ 24ʜʀs.</b>",
                protect_content=True
            )
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                ...
                await message.reply_text(
                    text="<b>👋 ʜᴇʏ {message.from_user.mention}, ʏᴏᴜ'ʀᴇ ᴀʀᴇ sᴜᴄᴄᴇssғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ ғᴏʀ 24ʜʀs ❤️‍🩹\n\nʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀɴʏ ᴍᴏᴠɪᴇ ғɪʟᴇs ᴡɪᴛʜᴏᴜᴛ ᴠᴇʀɪғɪʏ ᴜɴᴛɪʟʟ ɴᴇxᴛ 24ʜʀs.</b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return
    ...
    if not files_:
        ...
        try:
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                ...
                await message.reply_text(
                    text="<b>ʜᴇʟʟᴏ 👋🏻,\n\n📌 <u>ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪғʏ ᴛʜᴇ ʟɪɴᴋ ᴛᴏ ɢᴇᴛ ᴍᴏᴠɪᴇ ғɪʟᴇs, ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴡɪʟʟ ʙᴇ ᴇxᴘɪʀᴇᴅ ᴀғᴛᴇʀ 24 ʜᴏᴜʀs.</u>.</b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ !\nɢɪᴠᴇ ᴍᴇ ᴄᴏᴍᴍᴀɴᴅ ᴀʟᴏɴɢ ᴡɪᴛʜ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴀᴘɪ.\n\nꜰᴏʀᴍᴀᴛ : <code>/shortlink ModiJiUrl.com e36f2573636d8a5dd3b81b64ce434db80002867a</code>")
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/TamilSk_Demo</code></b>")
